...
const ROLE_CFG = {
  user:       { label: 'Usuário',    color: '#888888', bg: `${DS.colors.neutral.charcoal}CC`, border: DS.colors.neutral.dark },
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        {msg && (
          <div style={{
            ...
            borderRadius: '10px', 
            marginBottom: '16px',
            backgroundColor: msg.startsWith('✅') ? `${DS.colors.secondary.success}15` : `${DS.colors.secondary.error}15`,
            color: msg.startsWith('✅') ? DS.colors.secondary.success : DS.colors.secondary.error,
            border: `1px solid ${msg.startsWith('✅') ? DS.colors.secondary.success + '33' : DS.colors.secondary.error + '33'}`,
            fontSize: '14px', 
            fontWeight: '600',
          }}>
            {msg}
              ...
              <div key={u.id} style={{
                ...
                <div style={{
                  ...
                  <div style={{ flex: 1, minWidth: '140px' }}>
                    <p style={{ color: DS.colors.text.dark, fontWeight: '600', fontSize: '14px', marginBottom: '2px' }}>
                      {u.full_name ?? '—'}
                    </p>
                    <p style={{ color: DS.colors.text.secondary, fontSize: '12px' }}>{u.email}</p>
                  </div>
                  ...
                  {isAdmin && (
                    <button
                      ...
                      style={{
                        backgroundColor: isExp ? `${DS.colors.primary.main}15` : DS.colors.neutral.charcoal,
                        border: `1px solid ${isExp ? DS.colors.primary.main : DS.colors.neutral.dark}`,
                  ...
                  {loading === `role-${u.id}` && (
                    <span style={{ color: DS.colors.primary.main, fontSize: '12px' }}>Salvando...</span>
                  )}
                </div>
...
function ScopePanel({
  ...
  return (
    <div>
      ...
      <p style={{ color: DS.colors.text.secondary, fontSize: '12px', marginBottom: '12px' }}>{description}</p>

      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginBottom: '12px' }}>
        {items.length === 0 ? (
          <span style={{ color: DS.colors.text.secondary, fontSize: '12px', fontStyle: 'italic' }}>
      ...
      {options.length > 0 && (
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          <button
            ...
            style={{
              backgroundColor: selected ? color : DS.colors.neutral.charcoal,
              border: 'none', 
              color: 'white', 
              borderRadius: '8px',
              padding: '6px 14px', 
