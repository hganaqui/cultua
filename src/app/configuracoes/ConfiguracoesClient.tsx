// src/app/configuracoes/ConfiguracoesClient.tsx — Client Component
'use client'
...
export default function ConfiguracoesClient() {
  ...
  return (
    <main style={{ maxWidth: '700px', margin: '0 auto', padding: '40px 16px' }}>
      ...
      <Section title="Conta">
        <SettingRow icon="✉️" label="Alterar e-mail" desc="Em breve" />
        <SettingRow icon="🔑" label="Alterar senha"  desc="Em breve" />
        <SettingRow icon="👤" label="Editar nome"    desc="Em breve" />
      </Section>

      <Section title="Notificações">
        <SettingRow icon="🔔" label="Notificações por e-mail" desc="Em breve" />
      </Section>
...
function SettingRow({ icon, label, desc }: { icon: string; label: string; desc: string }) {
  return (
    <div style={{
      display: 'flex', alignItems: 'center', justifyContent: 'space-between',
      padding: '14px 0', borderBottom: '1px solid #F5F5F5', opacity: 0.5,
    }}>
